...
INSERT INTO public.bibliotecario (codigo_bibliotecario, nome, rg, cpf, nascimento, telefone, email) VALUES (1, 'Bibliotecario 01', '11.111.111-1', '111.111.111-11', '2001-01-01', '{45911111111,45911112222}', 'bibliotecario01@gmail.com');
INSERT INTO public.bibliotecario (codigo_bibliotecario, nome, rg, cpf, nascimento, telefone, email) VALUES (2, 'Bibliotecario 02', '22.222.222-2', '222.222.222-22', '2002-02-02', '{45922221111,45922222222}', 'bibliotecario02@gmail.com');
INSERT INTO public.bibliotecario (codigo_bibliotecario, nome, rg, cpf, nascimento, telefone, email) VALUES (3, 'Bibliotecario 03', '33.333.333-3', '333.333.333-33', '2003-03-03', '{45933331111,45933332222}', 'bibliotecario03@gmail.com');
INSERT INTO public.bibliotecario (codigo_bibliotecario, nome, rg, cpf, nascimento, telefone, email) VALUES (4, 'Bibliotecario 04', '44.444.444-4', '444.444.444-44', '2004-04-04', '{45944441111,45944442222}', 'bibliotecario04@gmail.com');
INSERT INTO public.bibliotecario (codigo_bibliotecario, nome, rg, cpf, nascimento, telefone, email) VALUES (5, 'Bibliotecario 05', '55.555.555-5', '555.555.555-55', '2005-05-05', '{45955551111,45955552222}', 'bibliotecario05@gmail.com');
...
INSERT INTO public.livro (isbn, palavras_chave, data_publicacao, titulo, codigo_editora, codigo_categoria, idioma, codigo_autor) VALUES (3, '{pc31,pc32}', '2000-01-03', 'Livro 03', 3, 5, 'PR-BR', 3);
INSERT INTO public.livro (isbn, palavras_chave, data_publicacao, titulo, codigo_editora, codigo_categoria, idioma, codigo_autor) VALUES (4, '{pc41,pc42}', '2000-01-04', 'Livro 04', 4, 2, 'PR-BR', 4);
INSERT INTO public.livro (isbn, palavras_chave, data_publicacao, titulo, codigo_editora, codigo_categoria, idioma, codigo_autor) VALUES (5, '{pc51,pc52}', '2000-01-05', 'Livro 05', 5, 3, 'PR-BR', 5);
INSERT INTO public.livro (isbn, palavras_chave, data_publicacao, titulo, codigo_editora, codigo_categoria, idioma, codigo_autor) VALUES (1, '{pc11,pc12}', '2000-01-01', 'Livro 01', 1, 2, 'EN-EN', 1);
INSERT INTO public.livro (isbn, palavras_chave, data_publicacao, titulo, codigo_editora, codigo_categoria, idioma, codigo_autor) VALUES (2, '{pc21,pc22}', '2000-01-02', 'Livro 02', 2, 3, 'EN-EN', 2);
INSERT INTO public.livro (isbn, palavras_chave, data_publicacao, titulo, codigo_editora, codigo_categoria, idioma, codigo_autor) VALUES (6, '{pc61,pc62}', '2000-01-06', 'Livro 06', 1, 2, 'EN-EN', 1);
...
INSERT INTO public.usuario (codigo_usuario, nome, nascimento, rg, cpf, telefone, email) VALUES (1, 'Usuário 01', '2000-01-01', '11.111.111-0', '111.111.111-00', '{45911111111,45911112222}', 'usuario01@outlook.com');
INSERT INTO public.usuario (codigo_usuario, nome, nascimento, rg, cpf, telefone, email) VALUES (2, 'Usuário 02', '2000-01-02', '22.222.222-0', '222.222.222-00', '{45922221111,45922222222}', 'usuario02@outlook.com');
INSERT INTO public.usuario (codigo_usuario, nome, nascimento, rg, cpf, telefone, email) VALUES (3, 'Usuário 03', '2000-01-03', '33.333.333-0', '333.333.333-00', '{45933331111,45933332222}', 'usuario03@outlook.com');
INSERT INTO public.usuario (codigo_usuario, nome, nascimento, rg, cpf, telefone, email) VALUES (4, 'Usuário 04', '2000-01-04', '44.444.444-0', '444.444.444-00', '{45944441111,45944442222}', 'usuario04@outlook.com');
INSERT INTO public.usuario (codigo_usuario, nome, nascimento, rg, cpf, telefone, email) VALUES (5, 'Usuário 05', '2000-01-05', '55.555.555-0', '555.555.555-00', '{45955551111,45955552222}', 'usuario05@outlook.com');
INSERT INTO public.usuario (codigo_usuario, nome, nascimento, rg, cpf, telefone, email) VALUES (6, 'Usuario 06', '2000-01-06', '66.666.666-6', '666.666.666-66', '{45966661111,45966662222}', 'usuario06@outlook.com');
...
-- Completed on 2022-08-07 13:17:14
